...
var addCarRows = function addCarRows(cars, tableId) {
  return cars.forEach(function (c) {
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/API/carsApiAxios.js":[function(require,module,exports) {
"use strict";
...
var getAllCars = function getAllCars() {
  return _axios.default.get("".concat(baseUrl, "/api/cars"));
};

exports.getAllCars = getAllCars;

var getCarById = function getCarById(id) {
  return _axios.default.get("".concat(baseUrl, "/api/cars/").concat(id));
};

exports.getCarById = getCarById;

var addCar = function addCar(car) {
  return _axios.default.post("".concat(baseUrl, "/api/cars"), car);
};
...
var _carsApiAxios = require("./API/carsApiAxios");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  buttonLoadCars.addEventListener('click', function (event) {
    ...
    (0, _carsApiAxios.getAllCars)().then(function (result) {
      return (0, _uiHelpers.addCarRows)(result.data, 'cars-table');
    });
  });
  ...
  buttonLoadCar.addEventListener('click', function (event) {
    ...
    (0, _carsApiAxios.getCarById)(carId).then(function (result) {
      return (0, _uiHelpers.populateEditCarForm)(result.data);
    });
  });
  ...
  buttonAddCar.addEventListener('click', function (event) {
    ...
    (0, _carsApiAxios.addCar)(car).then(function (_) {
      (0, _uiHelpers.cleanTable)('cars-table');
      return (0, _carsApiAxios.getAllCars)();
    }).then(function (result) {
      (0, _uiHelpers.addCarRows)(result.data, 'cars-table');
    });
  });
});
},{"./uiHelpers":"src/uiHelpers.js","./API/carsApiAxios":"src/API/carsApiAxios.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
